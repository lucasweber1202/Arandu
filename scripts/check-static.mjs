...
for (const file of htmlFiles) {
  ...
  if (!content.includes('css/arandu-system.css')) broken.push(`${file}: sem arandu-system.css`);
  if (!content.includes('js/site.js') && !file.startsWith('painel-')) broken.push(`${file}: sem js/site.js`);
}
...
console.log('Checklist estático aprovado para o MVP Arandu. Pesquisa estática e CSS crítico presentes.');
