/* ARANDU — loader centralizado público */
(function(){
  const version='20260609-public-3';
  const layers=[
    {id:'arandu-public-shell-css',src:`css/arandu-public-shell.css?v=${version}`,kind:'css',critical:true},
    {id:'arandu-experience-css',src:`css/arandu-experience.css?v=${version}`,kind:'css'},
    {id:'arandu-experience-js',src:`js/arandu-experience.js?v=${version}`,kind:'script'},
    ...
    {id:'arandu-architecture-css',src:`css/arandu-architecture.css?v=${version}`,kind:'css'}
  ];
  const loaded=[];
  const failed=[];
